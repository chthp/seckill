 ...
 * 
 * @author wb-dumao
 * @version $Id: SeckillController.java, v 0.1 2016年9月8日 上午10:13:39 wb-dumao Exp $
 */
...
public class SeckillController {
    ...
    @RequestMapping(value = "/{seckillId}/{md5}/execution", method = RequestMethod.POST, produces = { "application/json;charser=UTF-8 " })
    @ResponseBody
